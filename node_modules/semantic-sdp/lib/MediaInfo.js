...
class MediaInfo {
	 ...
	 * @param {String} type	- Media type "audio"|"video"|"application"
	 * @returns {MediaInfo}
	 */
	constructor(id, type) {
		this.id		= id;
	...
	answer(supported)
	{
		...
		if (supported)
		{
			...
			if (supported.dataChannel && this.dataChannel)
			{	
				//Crate info
				const dataChannelInfo = new DataChannelInfo(this.dataChannel.getPort(), supported.dataChannel.maxMessageSize ? supported.dataChannel.maxMessageSize : this.dataChannel.getMaxMessageSize());
				//Create it on answer
